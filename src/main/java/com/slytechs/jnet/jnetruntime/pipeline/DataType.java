...
public interface DataType {
     ...
     * }
     * </pre>
     * In this example, PcapDataType enum uses DataSupport to handle different types of PCAP data,
     * providing type-safe operations and compatibility checks for each data type.
     * </p>
     * 
    ...
    public final class DataSupport<T> implements DataType {
         ...
         * 
         * <p>
         * This constructor is typically used when implementing a DataType enum, as shown in the class example.
         * </p>
         * 
         * @param &lt;U&gt;          The type of user data that can be wrapped with the data
         * @param src          The source DataType, typically an enum implementing DataType
         ...
         * {@inheritDoc}
         * <p>
         * For Processor objects, checks compatibility with the processor's input.
         * For other objects, checks if they are instances of the data interface.
         * </p>
         */
        @Override
         ...
         * Otherwise, an array handler is created and applied to the list converted to an array.
         * </p>
         * 
         * <p>
         * In the context of the PcapDataType example, this method would be used to create
         * handlers for lists of NativeCallback or OfByteBuffer objects, depending on the data type.
         * </p>
         * 
         ...
         * 
         * <p>
         * This method allows attaching additional user-defined information to the data object.
         * In the PcapDataType example, this could be used to attach metadata to PCAP packets.
         * </p>
         * 
     ...
     * 
     * <p>
     * This method provides access to additional type-specific operations and checks.
     * </p>
     * 
