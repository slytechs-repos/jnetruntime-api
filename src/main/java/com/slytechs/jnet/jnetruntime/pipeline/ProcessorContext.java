...
/**
 * Represents a context for processors in a pipeline, managing hierarchical properties and relationships.
 * This class provides a mechanism for storing and retrieving typed properties in a hierarchical structure.
 *
 * <p>Example usage:
 * <pre>
...
public final class ProcessorContext {
    ...
    /**
     * Represents a key for storing properties in the context.
     * Each key is a combination of a name and a type.
     *
     ...
     * Removes all spaces and splits the string using '/' as the separator.
     *
     ...
     * @return An Optional containing the property value if found, or empty if not found
     */
    ...
    /**
     * Finds a property of the specified type and path in this context or its ancestors.
     *
     * @param <T> The type of the property
     * @param type The class of the property type
    ...
    /**
     * Gets a property of the specified type and path from this context or its ancestors.
     *
     * @param <T> The type of the property
     * @param type The class of the property type
     * @param path The path components to the property
